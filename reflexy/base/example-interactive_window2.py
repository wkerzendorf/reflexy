...
# Maybe figure can also be passed to the init
    ...
    class DataPlotterManager:
        ...
        def plotProductsGraphics(self, figure, canvas):
            if self.science_found == True and self.lineguess_found == True and self.flat_found == True:
                ...
                specdisp.display(
                    self.subplot_spectrum, title_spectrum, tooltip_spectrum,
                ...
                scatterdisp.display(
                    self.subplot_scatter, title_scatter, tooltip_scatter,
                    self.lineguess.x_column, self.lineguess.y_column)
...
"""
                ...
                twospecdisp.setLabels(
                    'Lambda', 'Flux ('+self.science.bunit+')')
